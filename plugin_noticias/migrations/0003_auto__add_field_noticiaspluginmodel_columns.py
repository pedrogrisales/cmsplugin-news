...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoticiasPluginModel.columns'
        db.add_column('cmsplugin_noticiaspluginmodel', 'columns',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoticiasPluginModel.columns'
        db.delete_column('cmsplugin_noticiaspluginmodel', 'columns')
