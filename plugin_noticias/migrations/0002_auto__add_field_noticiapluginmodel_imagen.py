...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NoticiaPluginModel.imagen'
        db.add_column('plugin_noticias_noticiapluginmodel', 'imagen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NoticiaPluginModel.imagen'
        db.delete_column('plugin_noticias_noticiapluginmodel', 'imagen_id')
